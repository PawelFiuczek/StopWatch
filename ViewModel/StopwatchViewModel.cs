    ...
    class StopwatchViewModel : INotifyPropertyChanged
    {
        ...
        public decimal Seconds
        {
            get
            {
                ...
                {
                    return (decimal)_stopwatchModel.Elapsed.Value.Seconds + (_stopwatchModel.Elapsed.Value.Milliseconds * 0.001M);
                }
                else
                    return 0.0M;
            }
        ...
        public decimal LapSeconds
        {
            get
            {
                ...
                {
                    return (decimal)_stopwatchModel.LapTime.Value.Seconds + (_stopwatchModel.LapTime.Value.Seconds * 0.001M);
                }
                else
                    return 0.0M;
            }
